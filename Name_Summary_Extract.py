...
def name_extract(text, label):
    ...
    """,
        "output": {"Name": "LEONARD ZAHN ASSOCIATES",
                    "Address": "55 VANDAM STREET NEW YORK, N. Y, 10013"}},
        ...
        "output":{"Name": "Gregory Davenport",
                    "Address": "119 Dana Stravenue, New Hampshire Lao People's Democratic Republic"}},
        ...
        "output": {"Name": "Bobby Ochoa",
                    "Address": "487 Kristi Cove, Vermont, Cambodia, 51595"}},
        ...
        "output": {"Name": "R. J. Reynolds",
                "Address": "401 North Main Street, Winston-Salem"}},
